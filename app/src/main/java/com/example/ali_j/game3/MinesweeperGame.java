...
public class MinesweeperGame extends Activity
{
    ...
    public TableLayout mineField; // table layout to add mines toC:\Users\ali_j\Downloads\Minesweeper\Source\src\com\VertexVerveInc\Games\MinesweeperGame.java
        ...
        for (int row = 1; row < numberOfRowsInMineField + 1; row++)
        {
            ...
            for (int column = 1; column < numberOfColumnsInMineField + 1; column++)
            {
                blocks[row][column].setLayoutParams(new TableRow.LayoutParams(
                        blockDimension + 40 * blockPadding,
                        blockDimension + 100 * blockPadding));
                blocks[row][column].setPadding(blockPadding, blockPadding, blockPadding, blockPadding);
                tableRow.addView(blocks[row][column]);
            }
            mineField.addView(tableRow,new TableLayout.LayoutParams(
                    (blockDimension + 40 * blockPadding) * numberOfColumnsInMineField, blockDimension + 100 * blockPadding));
        }
    }
